...
> **Repo:** [github.com/miha-stopar/sphincs-circuit](https://github.com/miha-stopar/sphincs-circuit) · branch `master` · crates `sphincs-circuit`, `sphincs-prover`, `sphincs-ref`  
> **This note:** `docs/HACKMD_NEUTRONNOVA_PLAN.md` in that repository.
...
*Last updated: 2026-05-29 — see repository `master` for commit hash at publish time.*
